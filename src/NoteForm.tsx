...
export function NoteForm({ onSubmit, onAddTag, availableTags, title = "", markdown = "", tags=[], }: NoteFormProps) {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    onSubmit({
      ...
      markdown: markdownRef.current!.value, // ! means never going to be null because we made these values "required" in Form.Controls below
      tags: selectedTags,
    });
    navigate("..")
  };
            ...
            <Form.Group controlId="tags">
              ...
              <CreatableReactSelect
                ...
                onChange={tags => {
                  setSelectedTags(
                    tags.map(tag => {
                      return { label: tag.label, id: tag.value };// converting the "value" given by the react select to "id" to match our Tag type, defined in App.tsx
                    })
                  );
                }}
                isMulti
